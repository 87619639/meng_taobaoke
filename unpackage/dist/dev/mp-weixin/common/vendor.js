...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__647085B" };exports.default = _default;
...
var _category = _interopRequireDefault(__webpack_require__(/*! ./modules/category */ 17));
var _good = _interopRequireDefault(__webpack_require__(/*! ./modules/good */ 22));
var _banner = _interopRequireDefault(__webpack_require__(/*! ./modules/banner */ 24));
var _activity = _interopRequireDefault(__webpack_require__(/*! ./modules/activity */ 25));
var _search = _interopRequireDefault(__webpack_require__(/*! ./modules/search */ 26));
var _footprint = _interopRequireDefault(__webpack_require__(/*! ./modules/footprint */ 27));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var store = new _vuex.default.Store({
  modules: {
    ...
    footprint: _footprint.default } });var _default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _api = __webpack_require__(/*! @/common/api */ 18);
...
var category = {
  ...
  mutations: {
    SET_CATEGORYS: function SET_CATEGORYS(state, categorys) {
    ...
    {var commit = _ref.commit;
      return new Promise(function (resolve, reject) {
        (0, _api.getCategory)().then(function (response) {
          var data = response.data.categorys;
  ...
  getters: {
    tcategorys: function tcategorys(state, getters, rootState) {
      return state.items;
    },
    categorys: function categorys(state, getters, rootState) {
      var temp = state.items.slice();
      temp.unshift({
        id: 0,
        name: "精选",
        sub_categorys: [] });
    ...
    gcategorys: function gcategorys(state, getters, rootState) {
      var temp = state.items.slice();
      temp.unshift({
        id: 0,
        name: "精选",
      ...
      return temp.map(function (item) {
        ...
        gtemp.sub_categorys = item.sub_categorys.map(function (sub) {
          return {
            id: sub.id,
            text: sub.name,
            image: sub.icon };
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getCategory = getCategory;exports.getGoods = getGoods;exports.getActGoods = getActGoods;exports.getRecommend = getRecommend;exports.getBanner = getBanner;exports.getActivity = getActivity;exports.getSearch = getSearch;exports.searchGoods = searchGoods;exports.getGoodDetail = getGoodDetail;exports.checkVersion = checkVersion;var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

function getCategory() {
  return _http.default.get('/api/category', {});
}
function getGoods(params) {
  return _http.default.get('/api/goods', params);
}
function getActGoods(params) {
  return _http.default.get('/api/goods/activity', params);
}
function getRecommend(params) {
  return _http.default.get('/api/goods/recommend', params);
}
function getBanner() {
  return _http.default.get('/api/banner');
}
function getActivity(params) {
  return _http.default.get('/api/activity', params);
}
function getSearch() {
  return _http.default.get('/api/search/worlds');
}
function searchGoods(params) {
  return _http.default.get('/api/search', params);
}
function getGoodDetail(params) {
  return _http.default.get('/api/goods/detail', params);
}
function checkVersion(params) {
  return _http.default.get('/api/app/check_version', params);
}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/common/request */ 20));
var _config = _interopRequireDefault(__webpack_require__(/*! @/common/config */ 21));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
var http = new _request.default();

http.setConfig(function (config) {
  config.baseUrl = _config.default.server;
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  server: "http://www.as178.com",
  channel: "1",
  versionName: "1.0.0",
  versionCode: '100' };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _util = __webpack_require__(/*! @/common/util */ 23);


var _api = __webpack_require__(/*! @/common/api */ 18);
...
var good = {
  ...
  mutations: {
    ADD_GOODS: function ADD_GOODS(state, data) {
      var item = state.items[data.cid];
      item.page = data.page;
      for (var i = 0, length = data.goods.length; i < length; i++) {
        var _good = data.goods[i];
        if (data.push) {
          item.data.push(_good);
        } else {
          item.data.unshift(_good);
        }
      }
    },
    ADD_RECOMMEND_GOODS: function ADD_RECOMMEND_GOODS(state, data) {
      ...
      if (data.page == 1) {
        ...
        for (var i = 0, length = data.goods.length; i < length; i++) {
          var _good2 = data.goods[i];
          if (data.push) {
            state.recommend.data.push(_good2);
          } else {
            state.recommend.data.unshift(_good2);
          }
        }
      }

    },
    ADD_ACTGOODS: function ADD_ACTGOODS(state, data) {
      state.actGoods.page = data.page;
      if (data.page == 1) {
        state.actGoods.data = data.goods;
      } else {
        for (var i = 0, length = data.goods.length; i < length; i++) {
          var _good3 = data.goods[i];
          if (data.push) {
            state.actGoods.data.push(_good3);
          } else {
            state.actGoods.data.unshift(_good3);
          }
        }
      }
    },
    INIT_GOODS: function INIT_GOODS(state, data) {
      var items = [];
    ...
    SET_GOOD: function SET_GOOD(state, data) {
      state.good = data;
    } },

  actions: {
    GetGoods: function GetGoods(_ref,

    options) {var commit = _ref.commit;
      var params = options;
      return new Promise(function (resolve, reject) {
        (0, _api.getGoods)(params).then(function (response) {
    ...
    GetActGoods: function GetActGoods(_ref2,

    options) {var commit = _ref2.commit;
      var params = options;
      return new Promise(function (resolve, reject) {
        (0, _api.getActGoods)(params).then(function (response) {
          var goods = response.data.goods;
          commit('ADD_ACTGOODS', {
            push: params.push,
            page: params.page,
    ...
    InitGoods: function InitGoods(_ref3,

    options) {var commit = _ref3.commit;
      commit('INIT_GOODS', options);
    },
    GetRecommend: function GetRecommend(_ref4,

    options) {var commit = _ref4.commit;
      var params = options;
      return new Promise(function (resolve, reject) {
        (0, _api.getRecommend)(params).then(function (response) {
          var goods = response.data.goods;
    ...
    GetGoodDetail: function GetGoodDetail(_ref5,


    options) {var commit = _ref5.commit,dispatch = _ref5.dispatch;
      var params = options;
      return new Promise(function (resolve, reject) {
        (0, _api.getGoodDetail)(params).then(function (response) {
  ...
  getters: {
    goods: function goods(state, getters, rootState) {
      return state.items.map(function (item) {
        ...
        temp.data = item.data.map(function (good) {
          return {
            dtitle: good.dtitle,
            id: good.id,
            ...
            sales_num: (0, _util.paseNum)(good.month_sales),
    ...
    actGoods: function actGoods(state, getters, rootState) {
      var temp = {
        page: state.actGoods.page,
        data: [] };

      temp.data = state.actGoods.data.map(function (good) {
        return {
          dtitle: good.dtitle,
          id: good.id,
          goods_id: good.goods_id,
    ...
    recommend: function recommend(state, getters, rootState) {

      var temp = {
        page: state.recommend.page,
        data: {} };

      temp.data = state.recommend.data.map(function (good) {
        return {
          dtitle: good.dtitle,
          id: good.id,
          goods_id: good.goods_id,
    ...
    good: function good(state, getters, rootState) {
      return state.good;
    } } };var _default =



good;exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.format = format;exports.paseNum = paseNum;exports.string2Date = string2Date;function format(str) {
  for (var i = 0; i < (arguments.length <= 1 ? 0 : arguments.length - 1); i++) {
    str = str.replace(new RegExp("\\{" + i + "\\}", "g"), i + 1 < 1 || arguments.length <= i + 1 ? undefined : arguments[i + 1]);}
  return str;
}
function paseNum(num) {var fixed = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var str;
  if (num > 99999999) {
...
var banner = {
  ...
  actions: {
    ...
    {var commit = _ref.commit;
      return new Promise(function (resolve, reject) {
        (0, _api.getBanner)().then(function (response) {
          var data = response.data.banner;
  ...
  getters: {
    banners: function banners(state, getters, rootState) {
      // console.log(state.items)
      var temp = [];var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
        for (var _iterator = state.items[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var item = _step.value;
          // console.log(item)
          if (item.type == 1) {
            temp.push(item);
          }
    ...
    index_1: function index_1(state, getters, rootState) {
      var temp = {};var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {
        for (var _iterator2 = state.items[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {var item = _step2.value;
          if (item.type == 2) {
            temp = item;
            break;
          }
...
banner;exports.default = _default;
...
var activity = {
  ...
  mutations: {
    SET_ACTIVITY: function SET_ACTIVITY(state, data) {
      state.items = data;
    } },

  actions: {

    GetActivity: function GetActivity(_ref)

    {var commit = _ref.commit;
      return new Promise(function (resolve, reject) {
        (0, _api.getActivity)().then(function (response) {
          var data = response.data.activity;
          var items = [];
          for (var i = 0, length = data.length; i < length; i++) {
            var item = data[i];
            items.push(item);
  ...
  getters: {
    activitys: function activitys(state, getters, rootState) {
      return state.items.map(function (item) {
        return {
          id: item.id,
          image: item.image,
...
var search = {
  ...
  actions: {
    GetSearch: function GetSearch(_ref)

    {var commit = _ref.commit;
      return new Promise(function (resolve, reject) {
        (0, _api.getSearch)().then(function (response) {
    ...
    SearchGoods: function SearchGoods(_ref2,

    options) {var commit = _ref2.commit;
      var params = options;
      return new Promise(function (resolve, reject) {
        (0, _api.searchGoods)(params).then(function (response) {
  ...
  getters: {
    searchs: function searchs(state, getters, rootState) {
    ...
    goods: function goods(state, getters, rootState) {
      ...
      temp.data = state.goods.data.map(function (good) {
        return {
          dtitle: good.dtitle,
          id: good.id,
          goods_id: good.goods_id,
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _util = __webpack_require__(/*! @/common/util */ 23);
...
var footprint = {
  ...
  mutations: {
    SET_GOODS: function SET_GOODS(state, goods) {
      state.goods = goods;
    },
    ADD_GOOD: function ADD_GOOD(state, good) {
      var has = function has(g) {var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
          for (var _iterator = state.goods[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var gd = _step.value;
            if (gd.id == g.id) {
              return true;
            }
          }} catch (err) {_didIteratorError = true;_iteratorError = err;} finally {try {if (!_iteratorNormalCompletion && _iterator.return != null) {_iterator.return();}} finally {if (_didIteratorError) {throw _iteratorError;}}}
    ...
    CLEAN_GOODS: function CLEAN_GOODS(state) {
      state.goods = [];
      uni.setStorageSync('footprint_goods', state.goods);
    },
    CLEAN_INVALID_GOODS: function CLEAN_INVALID_GOODS(state) {
      var now = new Date();
      for (var i = state.goods.length - 1; i >= 0; i--) {
        var g = state.goods[i];
        var end = new Date(g.coupon_end_time);
        if (end < now) {
  ...
  actions: {
    ...
    {var commit = _ref.commit;
      return new Promise(function (resolve, reject) {
        try {
          var goods = uni.getStorageSync('footprint_goods');
          if (goods) {
    ...
    AddGoods: function AddGoods(_ref2,

    good) {var commit = _ref2.commit;
      return new Promise(function (resolve, reject) {
        commit('ADD_GOOD', good);
        resolve();
      });
    },
    CleanGoods: function CleanGoods(_ref3) {var commit = _ref3.commit;
      return new Promise(function (resolve, reject) {
        commit('CLEAN_GOODS');
        resolve();
      });
    },
    CleanInvalidGoods: function CleanInvalidGoods(_ref4) {var commit = _ref4.commit;
      return new Promise(function (resolve, reject) {
  ...
  getters: {
    goods: function goods(state, getters, rootState) {
      var temp = [];
      var now = new Date();var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {
        for (var _iterator2 = state.goods[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {var g = _step2.value;
          var end = (0, _util.string2Date)(g.coupon_end_time);
          console.log(now);
          console.log(end);
          if (end > now) {
            temp.push(g);
    ...
    invalidGoods: function invalidGoods(state, getters, rootState) {
      var temp = [];
      var now = new Date();var _iteratorNormalCompletion3 = true;var _didIteratorError3 = false;var _iteratorError3 = undefined;try {
        for (var _iterator3 = state.goods[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {var g = _step3.value;
          var end = (0, _util.string2Date)(g.coupon_end_time);
          if (end < now) {
            temp.push(g);
          }
...
footprint;exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
